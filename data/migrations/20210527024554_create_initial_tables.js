...
exports.up = function(knex) {
  return knex.schema
    ...
    // the [species] table needs to be created first.
    ...
    .createTable('zoo_animals', tbl => {
      ...
      tbl
        ...
        .onDelete('CASCADE')
        .onUpdate('CASCADE');
      // This is how we can make a composite primary key -
      // the combination of the two keys becomes our primary key.
      // This will enforce unique combinations of ids.
      tbl.primary(['zoo_id', 'animal_id']);
    });
};

exports.down = function(knex) {
  // Drop in the opposite order to avoid errors related to FK constraints
  return knex.schema
